// Enterprise technology descriptions and information
...
export const enterpriseTechInfo: Record<string, TechInfo> = {
...
export function getEnterpriseTechInfo(techId: string): TechInfo | undefined {
  return enterpriseTechInfo[techId];
}
